...
export interface ApiFooterFooter extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    footer_column_left: Schema.Attribute.Component<
      'molecules.footer-column',
      false
    > &
    ...
    footer_column_right: Schema.Attribute.Component<
      'molecules.footer-column',
      false
    > &
      Schema.Attribute.SetPluginOptions<{
    ...
    footnote: Schema.Attribute.Blocks &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    publishedAt: Schema.Attribute.DateTime;
    social_link: Schema.Attribute.Component<'technical.icon-link', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiHeaderHeader extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    meta_robots: Schema.Attribute.Enumeration<
      [
        'noindex, nofollow',
        'noindex, follow',
        'index, follow',
...
export interface ApiSkillSkill extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    glowPathIds: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
